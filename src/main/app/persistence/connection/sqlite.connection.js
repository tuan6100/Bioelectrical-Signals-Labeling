...
const ddl = `
    ...
    CREATE INDEX patient_name_idx ON patients(first_name);
    ...
    CREATE INDEX session_time_idx ON sessions(start_time, end_time);
    CREATE INDEX session_content_hash_idx ON sessions(content_hash);
    ...
    CREATE INDEX channel_data_kind_sweep_idx ON channels(session_id, data_kind, sweep_index);
    CREATE INDEX channel_session_data_kind_idx ON channels(session_id, data_kind);
...
--     );
    ...
    CREATE INDEX label_name_idx ON labels(name);
